...
\newcommand{\TablePad}{\vspace{-0.7cm}}
...
\TablePad
\begin{tabularx}{\textwidth}{@{}p{0.10\textwidth}@{\hspace{0.01\textwidth}}p{0.89\textwidth}@{}}
  \BODY
\end{tabularx}
}
...
\begin{center}
  ...
  GitHub: \Website{github.com/\GitHubProfile}
  \\
...
\begin{EntriesTableDuration}
  \Duration{2022}{\Ongoing} & \textbf{Steering Council Member}, Fatiando a Terra, \Website{www.fatiando.org}
  \\
