...
University courses (Universidade do Estado do Rio de Janeiro):
\\

\cvitem{2015--Present}{``Special Mathematics I: Programming and Numerical
    Analysis''.
    Undergraduate level course for Oceanography majors.
    Online material:
    \href{https://github.com/leouieda/matematica-especial}{\texttt{github.com/leouieda/matematica-especial}}}

\cvitem{2015--Present}{``Geophysics II: Seismology''.
    Undergraduate level course for Geology majors.
    Online material:
    \href{https://github.com/leouieda/geofisica2}{\texttt{github.com/leouieda/geofisica2}}}

\cvitem{2014--Present}{``Geophysics I: Gravity and magnetic methods''.
    Undergraduate level course for Geology majors.
    Online material:
    \href{https://github.com/leouieda/geofisica1}{\texttt{github.com/leouieda/geofisica1}}}

\vspace{0.3cm}
Short courses:
\\

\cvitem{Feb 2016}{``Python for Earth Science''.
    Universidade de São Paulo, Brazil.
    Online material:
    \href{https://github.com/leouieda/verao2016}{\texttt{github.com/leouieda/verao2016}}}

\cvitem{Nov 2014}{``Introduction to Geophysical Inversion''.
    Universidade de Brasília, Brazil.
    Online material:
    \href{https://github.com/pinga-lab/inversao-unb-2014}{\texttt{github.com/pinga-lab/inversao-unb-2014}}}

\cvitem{Feb 2012}{``Introduction to Geophysical Inversion''.
    Universidade de São Paulo, Brazil.
    Online material:
    \href{https://github.com/pinga-lab/inversao-iag-2012}{\texttt{github.com/pinga-lab/inversao-iag-2012}}}


\section{Student supervision}

\cvitem{2015--Present}{Vinicius Vianna Riguête. Undergraduate. Project:
    ``Gravimetric study of Eo-Cretaceous intrusions in Namibia''.}

\cvitem{2016--Present}{Fernanda Vianna Gatts. Undergraduate. Project:
...
\begin{cvcolumns}
    \cvcolumn{}{\begin{itemize}
        \item
            Valéria C. F. Barbosa (MSc and PhD advisor)\\
            Full Researcher, Departamento de Geofísica\\
            Observatório Nacional - Rio de Janeiro, Brazil\\
            +55~21~35049235\\
            \href{mailto:valcris@on.br}{\texttt{valcris@on.br}}
            $\vert$
            \href{mailto:valeria.valcris@gmail.com}{\texttt{valeria.valcris@gmail.com}}
        \vspace{0.5cm}
        \item
            Carla Braitenberg\\
            Associate Professor, Dipartimento di Matematica e Geoscienze\\
            Universita' degli Studi di Trieste - Trieste, Italy\\
            +39~040~558~2258\\
            \href{mailto:berg@units.it}{\texttt{berg@units.it}}
        \vspace{0.5cm}
        \item
            Matt Hall\\
            Founder, Agile Geoscience
            (\href{http://www.agilegeoscience.com}{\texttt{www.agilegeoscience.com}})\\
            Mahone Bay, Canada\\
            +1~902~980~0130\\
            \href{mailto:matt@agilegeoscience.com}{\texttt{matt@agilegeoscience.com}}
            $\vert$
            \href{mailto:kwinkunks@gmail.com}{\texttt{kwinkunks@gmail.com}}
    \end{itemize}}
\end{cvcolumns}
