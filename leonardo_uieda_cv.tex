...
% HEADER
\begin{center}
    {\fontsize{26pt}{0}\selectfont\MyName}
\end{center}
\vspace{0.5cm}
...
\Year{2018}  &
    ...
    \newline
    ASPRS UHM Student Chapter -- University of Hawai'i at M\={a}noa
    \\
\Year{2017}  &
...
\Duration{2017}{}  &
    ...
    \newline
    Instituto Geofı́sico Sismológico Volponi, Universidad Nacional de San Juan, Argentina.
    \newline
...
\Duration{2015}{2017}  &
    ...
    \newline
    Faculdade de Geologia, Universidade do Estado do Rio de Janeiro, Brazil.
    \\
\end{EntriesTable}
...
\begin{EntriesTable}
    \Duration{2019} & Topic editor for the \textit{Journal of Open Source Software}
\end{EntriesTable}
...
\begin{EntriesTable}
    \Duration{2010}{} & American Geophysical Union
    \\
    \Duration{2011}{} & Society of Exploration Geophysicists
    \\
    \Duration{2014}{} & European Geosciences Union
\end{EntriesTable}
