...
\newcommand{\Address}{
    1680 East-West Rd -- POST 804, 96822 Honolulu, HI, USA
}
...
\begin{EntriesTable}
    ...
    \newline
    Developing a Python interface for the Generic Mapping Tools open-source
    software with Professor Paul Wessel.
    \\
    \Duration{2014}{}  &
    \textbf{Assistant Professor} (on leave),
    Universidade do Estado do Rio de Janeiro, Brazil
    \newline
    Professor of Geophysics at the Department of Applied Geology.
    \\
    \Duration{02}{3/2011}  &
    \textbf{Visiting Researcher},
    University of Trieste, Italy
    \newline
    Developing version 1.0 of the open-source software Tesseroids
...
* Year indicates when the project was started.
...
\subsection*{Non Peer-Reviewed Journal articles}
