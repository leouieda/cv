...
\newcommand{\Address}{
    1680 East-West Rd -- POST 804, Honolulu, HI, USA, 96822
}
...
\Year{submitted}  &
    ...
    spherical coordinates with application to lunar mascons. Under review at \emph{JGR
    Solid Earth}.
    \\
    ~ &
    \Bi, \Me, \Kristoffer, \Val.
    Should geophysicists use the gravity disturbance or the anomaly?
    Under review at \emph{Geophysics}.
    Preprint:
