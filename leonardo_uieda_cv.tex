...
\newcommand{\Preprint}[2]{\href{#1}{pdf}}
\newcommand{\PreprintDOI}[1]{\href{https://doi.org/#1}{pdf}}
\newcommand{\Slides}[2]{\href{#1}{slides}}
\newcommand{\SlidesDOI}[1]{\href{https://doi.org/#1}{slides}}
\newcommand{\Repo}[1]{\href{https://github.com/#1}{code}}
\newcommand{\Youtube}[1]{\href{https://youtu.be/#1}{video}}

% Tags to mark publications
%\newcommand{\ExtraInfo}[1]{\{ \ignorespaces#1\unskip\ \}}
\newcommand{\ExtraInfo}[1]{\{\ignorespaces#1\unskip\}}
...
\Year{2020}  &
  ...
  \ExtraInfo{\OA{} \Sep{} \Repo{fatiando/pooch}}
  \\
\Year{2019}  &
  ...
  \ExtraInfo{\OA{} \Sep{} \Repo{GenericMappingTools/gmt}}
  \\
  ~ &
  ...
  \ExtraInfo{
    \PreprintDOI{10.31223/osf.io/3548g} \Sep{}
  ...
  \ExtraInfo{\PreprintDOI{10.31223/osf.io/dzf9j}}
  \\
\Year{2018}  &
...
\Year{2017}  &
  ...
  \PreprintDOI{10.31223/osf.io/9ba4m}
  \\
\Year{2016}  &
  \Me, \Val, \Carla.
...
\begin{EntriesTable}
  ...
  \newline
  Teaching the lithosphere dynamics part (50\%) |
  ...
  \newline
  Teaching remote sensing, gravity surveying, and Python programming
  ($\sim$50\%)
  \newline
  \textit{\LIV}
  \\
  \Duration{2019}{\Ongoing}  &
  ENVS363: Geophysical Exploration Techniques
  \newline
