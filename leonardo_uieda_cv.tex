...
\firstname{Leonardo}
\familyname{Uieda}
\title{\emph{Curriculum Vit\ae\ - 03/2017}}
\address{
...
\cventry{2017--present}{Visiting Research Scholar}{}{University of Hawaii at
    Manoa}{USA}{Visiting researcher (postdoc) at the Department of Geology and
    Geophysics building a Python interface for the Generic Mapping Tools.
}
...
\cvitem{2017}{\textbf{Uieda, L}.
    Step-by-step NMO correction,
     \emph{The Leading Edge},
    doi:10.1190/tle36020179.1.
    \texttt{[\href{http://www.leouieda.com/papers/nmo-tutorial.html}{pdf}]}\texttt{[\href{https://github.com/pinga-lab/nmo-tutorial}{code}]}
}

\cvitem{2017}{\textbf{Uieda, L} and Barbosa, VCF. Fast non-linear
    gravity inversion in spherical coordinates with application to the South
    American Moho, \emph{Geophysical Journal International},
...
\cvitem{2016}{\textbf{Uieda, L}, Barbosa, VCF and Braitenberg, C.
...
\cvitem{10 Mar 2017}{University of Hawaii at Manoa, Honolulu - HI, USA.
    ``Inverting gravity to map the Moho: A new method and the open source
software that made it possible''}

\cvitem{22 Jun 2016}{Observatório Nacional, Rio de Janeiro, Brazil.
    ``Fatiando a Terra: construindo uma base para ensino e pesquisa de
geofísica''}

\cvitem{16 Apr 2015}{Universidade de São Paulo, São Paulo, Brazil.
    ``Fatiando a Terra: construindo uma base para ensino e pesquisa de
geofísica''}
