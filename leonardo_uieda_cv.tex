...
\Year{2021}  &
  \Me.
  Fatiando a Terra data: A curated collection of open geophysics data for
  tutorials and documentation.
  \DOI{10.5281/zenodo.5167356}
...
\begin{EntriesTable}
  ...
  \newline
  Teaching 3 lectures on non-linear inversion and machine learning
  \newline
  \textit{\LIV}
  \\
  \Duration{2020}{\Ongoing}  &
...
\begin{EntriesTable}
  \Duration{2021}{\Ongoing} & Software Underground Code of Conduct Working Group
  \\
...
\Duration{2020}{\Ongoing} &
  ...
  \\
\Duration{2020}{\Ongoing} &
  Earth Sciences Early Career Academic (ECA) representative,
  \LIV.
  \\
\Year{2015} &
  ...
  \\
\Duration{2015}{2017} &
  Faculty Advisor for the Society of Exploration Geophysicists
  (SEG) Student Chapter, \UERJ.
\end{EntriesTable}
